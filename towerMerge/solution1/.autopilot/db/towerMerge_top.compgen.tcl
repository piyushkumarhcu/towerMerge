...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_0_TDATA { O 576 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_1_TDATA { O 576 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_2_TDATA { O 576 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_3_TDATA { O 576 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_0_TREADY { I 1 bit } link_out_0_TVALID { O 1 bit } link_out_0_TLAST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_1_TREADY { I 1 bit } link_out_1_TVALID { O 1 bit } link_out_1_TLAST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_2_TREADY { I 1 bit } link_out_2_TVALID { O 1 bit } link_out_2_TLAST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { link_out_3_TREADY { I 1 bit } link_out_3_TVALID { O 1 bit } link_out_3_TLAST { O 1 vector } } \
} "
} else {
