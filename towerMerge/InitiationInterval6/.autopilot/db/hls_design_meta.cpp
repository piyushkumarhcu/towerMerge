...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("link_out_0_TREADY", 1, hls_in, 12, "axis", "out_acc", 1),
	Port_Property("link_out_1_TREADY", 1, hls_in, 13, "axis", "out_acc", 1),
	Port_Property("link_out_2_TREADY", 1, hls_in, 14, "axis", "out_acc", 1),
	Port_Property("link_out_3_TREADY", 1, hls_in, 15, "axis", "out_acc", 1),
