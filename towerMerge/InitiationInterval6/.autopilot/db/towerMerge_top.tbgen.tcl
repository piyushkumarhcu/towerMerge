...
set portList { 
	...
	{ link_out_0_TREADY sc_in sc_logic 1 outacc 12 } 
	{ link_out_1_TREADY sc_in sc_logic 1 outacc 13 } 
	{ link_out_2_TREADY sc_in sc_logic 1 outacc 14 } 
	{ link_out_3_TREADY sc_in sc_logic 1 outacc 15 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "link_out_0_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "link_out_0_V_data_V", "role": "default" }} , 
 	{ "name": "link_out_1_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "link_out_1_V_data_V", "role": "default" }} , 
 	{ "name": "link_out_2_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "link_out_2_V_data_V", "role": "default" }} , 
 	{ "name": "link_out_3_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "link_out_3_V_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_stitchInPhi_fu_250", "Parent" : "0", "Child" : ["2", "3", "4"],
		"CDFG" : "stitchInPhi",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_stitchInPhi_fu_250.grp_stitchNeighbors_fu_288", "Parent" : "1",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_stitchInPhi_fu_250.grp_stitchNeighbors_fu_296", "Parent" : "1",
		"CDFG" : "stitchNeighbors",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "Ai_data_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "Bi_data_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_stitchInPhi_fu_250.grp_stitchNeighbors_fu_304", "Parent" : "1",
		"CDFG" : "stitchNeighbors",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set ArgLastReadFirstWriteLatency {
	towerMerge_top {
		...
		link_out_0_V_data_V {Type O LastRead -1 FirstWrite 5}
		link_out_1_V_data_V {Type O LastRead -1 FirstWrite 5}
		link_out_2_V_data_V {Type O LastRead -1 FirstWrite 5}
		link_out_3_V_data_V {Type O LastRead -1 FirstWrite 5}
		link_out_0_V_user_V {Type O LastRead -1 FirstWrite 5}
		link_out_1_V_user_V {Type O LastRead -1 FirstWrite 5}
		link_out_2_V_user_V {Type O LastRead -1 FirstWrite 5}
		link_out_3_V_user_V {Type O LastRead -1 FirstWrite 5}
		link_out_0_V_last_V {Type O LastRead -1 FirstWrite 5}
		link_out_1_V_last_V {Type O LastRead -1 FirstWrite 5}
		link_out_2_V_last_V {Type O LastRead -1 FirstWrite 5}
		link_out_3_V_last_V {Type O LastRead -1 FirstWrite 5}}
	stitchInPhi {
		...
		p_read26 {Type I LastRead 3 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	link_out_0_V_data_V { axis {  { link_out_0_TREADY out_acc 0 1 }  { link_out_0_TDATA out_data 1 576 } } }
	link_out_1_V_data_V { axis {  { link_out_1_TREADY out_acc 0 1 }  { link_out_1_TDATA out_data 1 576 } } }
	link_out_2_V_data_V { axis {  { link_out_2_TREADY out_acc 0 1 }  { link_out_2_TDATA out_data 1 576 } } }
	link_out_3_V_data_V { axis {  { link_out_3_TREADY out_acc 0 1 }  { link_out_3_TDATA out_data 1 576 } } }
	...
	link_out_0_V_last_V { axis {  { link_out_0_TVALID out_vld 1 1 }  { link_out_0_TLAST out_data 1 1 } } }
	link_out_1_V_last_V { axis {  { link_out_1_TVALID out_vld 1 1 }  { link_out_1_TLAST out_data 1 1 } } }
	link_out_2_V_last_V { axis {  { link_out_2_TVALID out_vld 1 1 }  { link_out_2_TLAST out_data 1 1 } } }
	link_out_3_V_last_V { axis {  { link_out_3_TVALID out_vld 1 1 }  { link_out_3_TLAST out_data 1 1 } } }
}
