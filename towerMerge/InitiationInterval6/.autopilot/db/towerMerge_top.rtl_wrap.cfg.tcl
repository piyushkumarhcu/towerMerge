...
set DataType00 "[list ap_uint 576 ]"
...
set structArgument0 [list 576 8 0 0 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axiu<576, 8, 0, 0>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType10 "[list ap_uint 576 ]"
...
set structArgument1 [list 576 8 0 0 ]
set NameSpace1 [list ]
set structIsPacked1 "0"
set DataType1 [list "ap_axiu<576, 8, 0, 0>" "struct ap_axiu" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
